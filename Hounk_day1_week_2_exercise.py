...
product_names = ["oreo", "coke", "pepsi", "lays_chip", "pringles", "sour_worms", "choco_cookies", 
                 "donuts", "hot_dogs", "ice_cream", "gum", "pretzels", "kit_kat"]

product_ids = ["2323", "6545", "3456", "4567", "2134", "2362", "0923", "2786", "6723", "9237", "2092", "8246", "9276"]
...
for i in range(len(product_names)):
    ws.append([product_names[i], product_ids[i], max_amounts[i], reorder_thresholds[i], quantities[i]])
