...
first_names = ["Patrick", "Patricia", "Bernard","Chrisitan","Alice", "Thomas", "James", "Nicolas", "Mary", "Velda"]

# Create a list called last_names and prepopulate with 10 custom last names

last_names = ["Johnson", "Smith", "Williams","Brown", "Davis", "Garcia", "Miller", "Wilson", "Moore", "Taylor"]
